  ...
  return (
    <>
      ...
      <button 
        ...
        className="lg:hidden fixed top-4 left-4 z-50 p-2 bg-[#0A3A7A] text-white rounded-lg shadow-lg"
      >
      ...
      <aside className={cn(
        "w-64 bg-gradient-to-b from-[#0A3A7A] to-[#082D5F] text-white flex flex-col min-h-screen fixed left-0 top-0 z-40 border-r border-white/5 transition-transform duration-300 lg:translate-x-0",
